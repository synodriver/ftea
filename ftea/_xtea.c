...
#define __PYX_HAVE__ftea___xtea
#define __PYX_HAVE_API__ftea___xtea
/* Early includes */
#include <stdint.h>
#include <string.h>
#include "xtea.h"
...
/*--- Type declarations ---*/
struct __pyx_obj_4ftea_5_xtea_XTEA;
...
struct __pyx_obj_4ftea_5_xtea_XTEA {
  PyObject_HEAD
  struct __pyx_vtabstruct_4ftea_5_xtea_XTEA *__pyx_vtab;
  xtea_t _tea;
};
...
struct __pyx_vtabstruct_4ftea_5_xtea_XTEA {
  int (*encode_into)(struct __pyx_obj_4ftea_5_xtea_XTEA *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch);
  int (*decode_into)(struct __pyx_obj_4ftea_5_xtea_XTEA *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_4ftea_5_xtea_XTEA *__pyx_vtabptr_4ftea_5_xtea_XTEA;
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_4XTEA_encode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch);
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_4XTEA_decode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch);
...
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_4XTEA_encode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv, CYTHON_UNUSED int __pyx_skip_dispatch); /* proto*/
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_4XTEA_decode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv, CYTHON_UNUSED int __pyx_skip_dispatch); /* proto*/
...
/* Module declarations from 'ftea.xtea' */

/* Module declarations from 'ftea._xtea' */
static PyTypeObject *__pyx_ptype_4ftea_5_xtea_XTEA = 0;
...
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_enclen(int, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_declen(int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "ftea._xtea"
extern int __pyx_module_is_main_ftea___xtea;
int __pyx_module_is_main_ftea___xtea = 0;

/* Implementation of 'ftea._xtea' */
...
static const char __pyx_k_XTEA[] = "XTEA";
...
static PyObject *__pyx_n_s_XTEA;
...
static PyObject *__pyx_pf_4ftea_5_xtea_enclen(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_l); /* proto */
static PyObject *__pyx_pf_4ftea_5_xtea_2declen(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_l); /* proto */
static int __pyx_pf_4ftea_5_xtea_4XTEA___cinit__(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_key); /* proto */
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_2encode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv); /* proto */
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_4decode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv); /* proto */
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
...
static PyObject *__pyx_tp_new_4ftea_5_xtea_XTEA(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
static PyObject *__pyx_pw_4ftea_5_xtea_1enclen(PyObject *__pyx_self, PyObject *__pyx_arg_l); /*proto*/
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_enclen(int __pyx_v_l, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("enclen", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_4ftea_5_xtea_1enclen(PyObject *__pyx_self, PyObject *__pyx_arg_l); /*proto*/
static char __pyx_doc_4ftea_5_xtea_enclen[] = "enclen(int l) -> int";
static PyObject *__pyx_pw_4ftea_5_xtea_1enclen(PyObject *__pyx_self, PyObject *__pyx_arg_l) {
  int __pyx_v_l;
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("enclen (wrapper)", 0);
  assert(__pyx_arg_l); {
    __pyx_v_l = __Pyx_PyInt_As_int(__pyx_arg_l); if (unlikely((__pyx_v_l == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("ftea._xtea.enclen", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4ftea_5_xtea_enclen(__pyx_self, ((int)__pyx_v_l));
...
static PyObject *__pyx_pf_4ftea_5_xtea_enclen(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_l) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4ftea_5_xtea_enclen(__pyx_v_l, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 12, __pyx_L1_error)
...
static PyObject *__pyx_pw_4ftea_5_xtea_3declen(PyObject *__pyx_self, PyObject *__pyx_arg_l); /*proto*/
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_declen(int __pyx_v_l, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("declen", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_4ftea_5_xtea_3declen(PyObject *__pyx_self, PyObject *__pyx_arg_l); /*proto*/
static char __pyx_doc_4ftea_5_xtea_2declen[] = "declen(int l) -> int";
static PyObject *__pyx_pw_4ftea_5_xtea_3declen(PyObject *__pyx_self, PyObject *__pyx_arg_l) {
  int __pyx_v_l;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("declen (wrapper)", 0);
  assert(__pyx_arg_l); {
    __pyx_v_l = __Pyx_PyInt_As_int(__pyx_arg_l); if (unlikely((__pyx_v_l == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 15, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("ftea._xtea.declen", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4ftea_5_xtea_2declen(__pyx_self, ((int)__pyx_v_l));
...
static PyObject *__pyx_pf_4ftea_5_xtea_2declen(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_l) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("declen", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4ftea_5_xtea_declen(__pyx_v_l, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* Python wrapper */
static int __pyx_pw_4ftea_5_xtea_4XTEA_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_4ftea_5_xtea_4XTEA_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    __pyx_v_key = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_key.memview)) __PYX_ERR(1, 23, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 1, 1, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ftea._xtea.XTEA.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4ftea_5_xtea_4XTEA___cinit__(((struct __pyx_obj_4ftea_5_xtea_XTEA *)__pyx_v_self), __pyx_v_key);
...
static int __pyx_pf_4ftea_5_xtea_4XTEA___cinit__(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_key) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 */
  __pyx_t_1 = 0;
  xtea_setkey((&__pyx_v_self->_tea), ((unsigned char const *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_key.data) + __pyx_t_1)) ))))));
...
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_3encode_into(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_4XTEA_encode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_ret;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
 ...
 */
        ...
        __pyx_t_2 = 0;
        __pyx_t_3 = 0;
        __pyx_v_ret = xtea_encode((&__pyx_v_self->_tea), ((void *)(&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_outbuf.data) + __pyx_t_1)) ))))), ((void const *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_2)) ))))), ((int)(__pyx_v_data.shape[0])), (&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_iv.data) + __pyx_t_3)) )))));
      }
...
/* Python wrapper */
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_3encode_into(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4ftea_5_xtea_4XTEA_2encode_into[] = "XTEA.encode_into(self, const uint8_t[::1] data, uint8_t[::1] outbuf, uint8_t[::1] iv) -> int";
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_3encode_into(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_outbuf = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_iv = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("encode_into (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_outbuf,&__pyx_n_s_iv,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_outbuf)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("encode_into", 1, 3, 3, 1); __PYX_ERR(1, 27, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_iv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("encode_into", 1, 3, 3, 2); __PYX_ERR(1, 27, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "encode_into") < 0)) __PYX_ERR(1, 27, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(1, 27, __pyx_L3_error)
    __pyx_v_outbuf = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_outbuf.memview)) __PYX_ERR(1, 27, __pyx_L3_error)
    __pyx_v_iv = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_iv.memview)) __PYX_ERR(1, 27, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("encode_into", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 27, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ftea._xtea.XTEA.encode_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4ftea_5_xtea_4XTEA_2encode_into(((struct __pyx_obj_4ftea_5_xtea_XTEA *)__pyx_v_self), __pyx_v_data, __pyx_v_outbuf, __pyx_v_iv);
...
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_2encode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("encode_into", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_data.memview)) { __Pyx_RaiseUnboundLocalError("data"); __PYX_ERR(1, 27, __pyx_L1_error) }
  if (unlikely(!__pyx_v_outbuf.memview)) { __Pyx_RaiseUnboundLocalError("outbuf"); __PYX_ERR(1, 27, __pyx_L1_error) }
  if (unlikely(!__pyx_v_iv.memview)) { __Pyx_RaiseUnboundLocalError("iv"); __PYX_ERR(1, 27, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4ftea_5_xtea_4XTEA_encode_into(__pyx_v_self, __pyx_v_data, __pyx_v_outbuf, __pyx_v_iv, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_outbuf, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_iv, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_5decode_into(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE int __pyx_f_4ftea_5_xtea_4XTEA_decode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_ret;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  __Pyx_RefNannySetupContext("decode_into", 0);
 ...
 */
        ...
        __pyx_t_2 = 0;
        __pyx_t_3 = 0;
        __pyx_v_ret = xtea_decode((&__pyx_v_self->_tea), ((void *)(&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_outbuf.data) + __pyx_t_1)) ))))), ((void const *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_2)) ))))), ((int)(__pyx_v_data.shape[0])), (&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_iv.data) + __pyx_t_3)) )))));
      }
...
/* Python wrapper */
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_5decode_into(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4ftea_5_xtea_4XTEA_4decode_into[] = "XTEA.decode_into(self, const uint8_t[::1] data, uint8_t[::1] outbuf, uint8_t[::1] iv) -> int";
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_5decode_into(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_outbuf = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_iv = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("decode_into (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_outbuf,&__pyx_n_s_iv,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_outbuf)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("decode_into", 1, 3, 3, 1); __PYX_ERR(1, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_iv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("decode_into", 1, 3, 3, 2); __PYX_ERR(1, 33, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decode_into") < 0)) __PYX_ERR(1, 33, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(1, 33, __pyx_L3_error)
    __pyx_v_outbuf = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_outbuf.memview)) __PYX_ERR(1, 33, __pyx_L3_error)
    __pyx_v_iv = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_iv.memview)) __PYX_ERR(1, 33, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decode_into", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 33, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ftea._xtea.XTEA.decode_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4ftea_5_xtea_4XTEA_4decode_into(((struct __pyx_obj_4ftea_5_xtea_XTEA *)__pyx_v_self), __pyx_v_data, __pyx_v_outbuf, __pyx_v_iv);
...
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_4decode_into(struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_outbuf, __Pyx_memviewslice __pyx_v_iv) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  if (unlikely(!__pyx_v_outbuf.memview)) { __Pyx_RaiseUnboundLocalError("outbuf"); __PYX_ERR(1, 33, __pyx_L1_error) }
  if (unlikely(!__pyx_v_iv.memview)) { __Pyx_RaiseUnboundLocalError("iv"); __PYX_ERR(1, 33, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4ftea_5_xtea_4XTEA_decode_into(__pyx_v_self, __pyx_v_data, __pyx_v_outbuf, __pyx_v_iv, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_4ftea_5_xtea_4XTEA_6__reduce_cython__[] = "XTEA.__reduce_cython__(self)";
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_7__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_4ftea_5_xtea_4XTEA_6__reduce_cython__(((struct __pyx_obj_4ftea_5_xtea_XTEA *)__pyx_v_self));
...
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("ftea._xtea.XTEA.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static char __pyx_doc_4ftea_5_xtea_4XTEA_8__setstate_cython__[] = "XTEA.__setstate_cython__(self, __pyx_state)";
static PyObject *__pyx_pw_4ftea_5_xtea_4XTEA_9__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_4ftea_5_xtea_4XTEA_8__setstate_cython__(((struct __pyx_obj_4ftea_5_xtea_XTEA *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_4ftea_5_xtea_4XTEA_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("ftea._xtea.XTEA.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static struct __pyx_vtabstruct_4ftea_5_xtea_XTEA __pyx_vtable_4ftea_5_xtea_XTEA;

static struct __pyx_obj_4ftea_5_xtea_XTEA *__pyx_freelist_4ftea_5_xtea_XTEA[8];
static int __pyx_freecount_4ftea_5_xtea_XTEA = 0;

static PyObject *__pyx_tp_new_4ftea_5_xtea_XTEA(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_4ftea_5_xtea_XTEA *p;
  PyObject *o;
  if (CYTHON_COMPILING_IN_CPYTHON && likely((__pyx_freecount_4ftea_5_xtea_XTEA > 0) & (t->tp_basicsize == sizeof(struct __pyx_obj_4ftea_5_xtea_XTEA)))) {
    o = (PyObject*)__pyx_freelist_4ftea_5_xtea_XTEA[--__pyx_freecount_4ftea_5_xtea_XTEA];
    memset(o, 0, sizeof(struct __pyx_obj_4ftea_5_xtea_XTEA));
    (void) PyObject_INIT(o, t);
  } else {
    o = (*t->tp_alloc)(t, 0);
    if (unlikely(!o)) return 0;
  }
  p = ((struct __pyx_obj_4ftea_5_xtea_XTEA *)o);
  p->__pyx_vtab = __pyx_vtabptr_4ftea_5_xtea_XTEA;
  if (unlikely(__pyx_pw_4ftea_5_xtea_4XTEA_1__cinit__(o, a, k) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_4ftea_5_xtea_XTEA(PyObject *o) {
  if (CYTHON_COMPILING_IN_CPYTHON && ((__pyx_freecount_4ftea_5_xtea_XTEA < 8) & (Py_TYPE(o)->tp_basicsize == sizeof(struct __pyx_obj_4ftea_5_xtea_XTEA)))) {
    __pyx_freelist_4ftea_5_xtea_XTEA[__pyx_freecount_4ftea_5_xtea_XTEA++] = ((struct __pyx_obj_4ftea_5_xtea_XTEA *)o);
  } else {
    (*Py_TYPE(o)->tp_free)(o);
  }
}

static PyMethodDef __pyx_methods_4ftea_5_xtea_XTEA[] = {
  {"encode_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4ftea_5_xtea_4XTEA_3encode_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4ftea_5_xtea_4XTEA_2encode_into},
  {"decode_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4ftea_5_xtea_4XTEA_5decode_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4ftea_5_xtea_4XTEA_4decode_into},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_4ftea_5_xtea_4XTEA_7__reduce_cython__, METH_NOARGS, __pyx_doc_4ftea_5_xtea_4XTEA_6__reduce_cython__},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_4ftea_5_xtea_4XTEA_9__setstate_cython__, METH_O, __pyx_doc_4ftea_5_xtea_4XTEA_8__setstate_cython__},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_4ftea_5_xtea_XTEA = {
  PyVarObject_HEAD_INIT(0, 0)
  "ftea._xtea.XTEA", /*tp_name*/
  sizeof(struct __pyx_obj_4ftea_5_xtea_XTEA), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_4ftea_5_xtea_XTEA, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_4ftea_5_xtea_XTEA, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_4ftea_5_xtea_XTEA, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "ftea._xtea._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"enclen", (PyCFunction)__pyx_pw_4ftea_5_xtea_1enclen, METH_O, __pyx_doc_4ftea_5_xtea_enclen},
  {"declen", (PyCFunction)__pyx_pw_4ftea_5_xtea_3declen, METH_O, __pyx_doc_4ftea_5_xtea_2declen},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__xtea(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__xtea},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_XTEA, __pyx_k_XTEA, sizeof(__pyx_k_XTEA), 0, 0, 1, 1},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  __pyx_vtabptr_4ftea_5_xtea_XTEA = &__pyx_vtable_4ftea_5_xtea_XTEA;
  __pyx_vtable_4ftea_5_xtea_XTEA.encode_into = (int (*)(struct __pyx_obj_4ftea_5_xtea_XTEA *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch))__pyx_f_4ftea_5_xtea_4XTEA_encode_into;
  __pyx_vtable_4ftea_5_xtea_XTEA.decode_into = (int (*)(struct __pyx_obj_4ftea_5_xtea_XTEA *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch))__pyx_f_4ftea_5_xtea_4XTEA_decode_into;
  if (PyType_Ready(&__pyx_type_4ftea_5_xtea_XTEA) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_4ftea_5_xtea_XTEA.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_4ftea_5_xtea_XTEA.tp_dictoffset && __pyx_type_4ftea_5_xtea_XTEA.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_4ftea_5_xtea_XTEA.tp_getattro = __Pyx_PyObject_GenericGetAttrNoDict;
  }
  if (__Pyx_SetVtable(__pyx_type_4ftea_5_xtea_XTEA.tp_dict, __pyx_vtabptr_4ftea_5_xtea_XTEA) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_XTEA, (PyObject *)&__pyx_type_4ftea_5_xtea_XTEA) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_4ftea_5_xtea_XTEA) < 0) __PYX_ERR(1, 21, __pyx_L1_error)
  __pyx_ptype_4ftea_5_xtea_XTEA = &__pyx_type_4ftea_5_xtea_XTEA;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_xtea(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_xtea(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__xtea(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__xtea(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__xtea(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_xtea' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__xtea(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_xtea", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ftea___xtea) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ftea._xtea")) {
      if (unlikely(PyDict_SetItemString(modules, "ftea._xtea", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ftea._xtea", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ftea._xtea");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
